...
class student
{
    ...
    friend io_status fillOne(student* x, const char* newname, int newvalue)
    {
        return x->init(newname, newvalue);
    }
    void swap(student& x)
    {
	    char* n;
    ...
    friend io_status formulaeFill(student* array, int size, int formulae);
};
